...
public class FOGNODE {
    ...
    FOGNODE(double id, double Capacity, double RAM, double CPU, double AW, String Status, double latitude, double longitude){
        this.id = id;
    ...
    public void setReq(double reqId,String reqType, double startTime, double duration, double reqRam, double reqCapacity, double reqCPU)throws Exception {
        ...
        String tempType[] = new String[this.reqtype.length+1];
